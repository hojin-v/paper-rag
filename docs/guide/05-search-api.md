...
| 시트 | 내용 |
| --- | --- |
| 검색 결과 요약 | 질의, 추출/매칭 키워드, 매칭 방식, 검색 설명, 대표/연관 논문, 선정 사유 |
| 대표 논문 정보 | 제목, 저자, 연도, 저널, 초록 원문·요약, 전문 링크, 키워드 |
| 대표 논문 섹션 | 섹션 순서·이름, 단락 수, 섹션 원문·정제문·요약·키워드 |
| 대표 논문 단락 | 단락 번호, 섹션명, 원문, 정제문, 요약, 키워드 |
| 연관 논문 정보 | 대표 논문 정보 항목 + 연관 점수, 연관 사유 |
| 연관 논문 섹션 | 섹션 순서·이름, 단락 수, 섹션 원문·정제문·요약·키워드 |
| 연관 논문 단락 | 단락 번호, 섹션명, 원문, 정제문, 요약, 키워드 |
| 표 데이터 | 구분, 표 제목, 표 내용, 표 요약 |
| 표 셀 | 대표/연관 구분, 표 번호·제목, 행·열 번호, 셀 값 |

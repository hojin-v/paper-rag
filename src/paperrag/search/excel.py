...
from paperrag.search.schemas import PaperInfo, ParagraphInfo, ResultBundle, TableInfo
...
def build_excel(data: ResultBundle, out_path: str | Path) -> str:
    ...
    for sheet in workbook.worksheets:
        _style_sheet(sheet)
    for sheet_name in ("대표 논문 단락", "연관 논문 단락"):
...
def _write_paper_info(
    ...
    *,
    ...
    headers = ["논문 ID", "제목", "저자", "연도", "저널", "초록 요약", "전문 링크", "키워드"]
